...
require("dotenv").config({ path: "C:/Users/Paul/slow-habits-api/.env" });
var dbUsername = process.env.DB_USERNAME;
var dbPassword = process.env.DB_USERNAME;
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    uri = "mongodb+srv://" + dbUsername + ":" + dbPassword + " @cluster0.xiv8n.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
